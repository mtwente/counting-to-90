...
I am using the [*nordatlantisk-ft*](https://mtwente.github.io/nordatlantisk-ft) data set I created for this project, containing voting records of Folketinget members from Greenland and the Faroe Islands. The dataset is the result of a workflow in R, taking a list of MPs as input and then scraping voting records from Folketinget's Open Data Platform [@folketingetFolketingetsAbneData2026]. Both workflow and dataset are version-controlled using git, including long-term archival on Zenodo, and are accompanied by extensive metadata and documentation to ensure reproducibility [@mahrOneTemplateRule2025a]. The codebook is available online [@twenteNordatlantiskft2024]. 
